...
const { depositCoinUSDTBEP20 } = require('./addDataBlockchain')
const linkRPC = process.env.START == 'MAINNET' ? `wss://smart-capable-pallet.bsc.discover.quiknode.pro/59f691dace13174c585574cca37f22f74a6570ad/` : `https://data-seed-prebsc-1-s1.binance.org:8545/`
...
//     }
// ))
const web3 = new Web3(`https://smart-capable-pallet.bsc.discover.quiknode.pro/59f691dace13174c585574cca37f22f74a6570ad/`)
const web3Http = new Web3(`https://smart-capable-pallet.bsc.discover.quiknode.pro/59f691dace13174c585574cca37f22f74a6570ad/`)
const networkId = process.env.START == 'MAINNET' ? 56 : 97
...
async function getEventContract() {
    ...
    usdtInstance.getPastEvents(`Transfer`, { fromBlock: lastBlock, toBlock: toBlock }
        , (err, result) => {
            ...
            if (result) {
                for (item of result) {
                    arrayPromise.push(depositCoinUSDTBEP20(item))
                }
            }
